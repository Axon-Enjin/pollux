> Materialized file. Edit `docs/build-pollux.md` and re-run materialize.

# FMD pointer

**Pinned engine:** FMD 1.19.0 at `D:\PROJECTS\FMD` (tag v1.19.0). Fetch templates from there. Session docs live under `docs/`. Validate with `python D:\PROJECTS\FMD\scripts\check.py D:\PROJECTS\pollux\docs` (add scale full when checking completeness).

Below is the project Build Guide (from BUILD). For FMD routing tables, open the engine `AGENTS.md` in the FMD clone.
...
**PRD:** [docs/prd-pollux.md](docs/prd-pollux.md)
**SDD:** [docs/sdd-pollux.md](docs/sdd-pollux.md)
**SAD:** [docs/sad-pollux.md](docs/sad-pollux.md)
